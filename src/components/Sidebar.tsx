...
const Sidebar = () => {
    ...
    return (
        <aside className="sticky top-[76px] h-[calc(100dvh-172px)] hidden shrink-0 sm:sticky sm:block py-8 border-r w-[216px] select-none">
                ...
                <div className="flex flex-col items-stretch gap-6 justify-between h-full">
                    <div className="flex flex-col gap-1 text-sm font-medium">
                        <NavLink
                            to="/"
                            className={({ isActive }) =>
                                isActive ? "bg-muted hover:bg-secondary/40" : "hover:bg-secondary/40"
                            }
                        >
